...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue added people to the front instead of the back of the queue.
    ...
    // Defect(s) Found: New people were added to the front instead of the back, breaking FIFO order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: A person with 0 turns was not placed back into the queue for infinite turns.
    ...
    // Defect(s) Found: A person with negative turns was not placed back into the queue for infinite turns.
    ...
    // Defect(s) Found: None. The empty queue exception worked correctly.
